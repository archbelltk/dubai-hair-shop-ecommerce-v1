...
const DHS_PRODUCTS = [
  // Hair Extensions
  { id: 'hair-brazilian-straight', name: 'Brazilian Straight Bundle', category: 'hair-extensions', categoryLabel: 'Hair Extensions', price: 850, image: 'img/brazilian-straight-bundle.png', badge: 'Bestseller', description: 'Silky, tangle-free Brazilian human hair bundles with a natural shine that blends seamlessly with any texture.' },
  { id: 'hair-deep-wave-lace', name: 'Deep Wave Lace Front', category: 'hair-extensions', categoryLabel: 'Hair Extensions', price: 1450, image: 'img/deep-wave-lace-front.png', badge: 'New', description: 'A pre-plucked deep wave lace front wig for a natural hairline and effortless glam, install-ready.' },
  ...
  // Fashion Design
  { id: 'fashion-ankara-midi-dress', name: 'Ankara Midi Dress', category: 'fashion-design', categoryLabel: 'Fashion Design', price: 620, originalPrice: 780, image: 'img/ankara-midi-dress.png', badge: 'Sale', description: 'A vibrant Ankara midi dress tailored for a flattering silhouette, perfect for day-to-night styling.' },
  ...
  // Natural Skincare
  { id: 'skincare-shea-glow-serum', name: 'Shea Glow Face Serum', category: 'natural-skincare', categoryLabel: 'Natural Skincare', price: 1200, image: 'img/shea-glow-face Serum.png', description: 'A nourishing face serum blended with shea and African botanicals for a radiant, even-toned glow.' },
